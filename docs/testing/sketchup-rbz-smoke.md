...
5. With TestUp installed, run `test/sketchup/main_thread_dispatcher_smoke_test.rb`. The timer callback must run and access `Sketchup.active_model` successfully.
