...
Sketchup.require File.join(Giaokhoa::SketchupMcp::ROOT, 'layout_primitive_engine')
Sketchup.require File.join(Giaokhoa::SketchupMcp::ROOT, 'presentation_engine')
Sketchup.require File.join(Giaokhoa::SketchupMcp::ROOT, 'documentation_snapshot_builder')
Sketchup.require File.join(Giaokhoa::SketchupMcp::ROOT, 'layout_sheet_builder')
